...
import pyperclip # importing pyperclip to allow us copy/paste items to our clipboard
...
class TestContact(unittest.TestCase):
    ...
    # other test: saving multiple contacts
    ...
    # testing to see if contact exists
    ...
    # copying email address from a found contact 
